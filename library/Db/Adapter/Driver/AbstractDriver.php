...
{
	return (isset($this->dbh)) ? $this->dbh : FALSE;
}
...
*/
abstract public function exec($stmt, array $params = array());
...
*/
public function getAssocRow($query, array $params = array())
{
	return ($sth = $this->query($query, $params))
		? $sth->fetchAssocRow()
		: FALSE;
...
*                fetch mode, or FALSE if there's no data or error
*/
public function getNumRow($query, array $params = array())
{
	return ($sth = $this->query($query, $params))
		? $sth->fetchNumRow()
		: FALSE;
...
*
* @return boolean TRUE if a transaction is currently active, or FALSE if not
*/
